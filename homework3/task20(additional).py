...
def Value():
    ...
    value = {1 : 'AEIOULNSTRАВЕИНОРСТ', 
             ...
             10 : 'QZФЩЪ'}  
    result = 0
    for char in word.upper(): # т.к. значения в словаре загалвные буквы, то переводим все в верхний регистр
        for key, val in value.items():
            if char in val: # Если символ в значении, то складываем его ключ (стоимость)
                result += key                      
    return result
